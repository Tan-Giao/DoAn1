...
namespace DoAn1.Controllers
{
    public class PaymentMethodsController : Controller
    {
        ...
        public PaymentMethodsController(QlbhdtContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("PaymentMethodId,MethodName")] PaymentMethod paymentMethod)
        {
